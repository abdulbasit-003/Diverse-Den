...
class _Upload3DModelScreenState extends State<Upload3DModelScreen> {
  ...
  Future<void> _upload3DModel() async {
    ...
    var product = await DatabaseService.getProductBySKU(_skuController.text, _businessId!);
    print(product);
    if (product == null) {
    ...
    try {
      await DatabaseService.assignModelToProduct(_skuController.text, _selectedModel!.path);
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 10),
            ElevatedButton(
              onPressed: _upload3DModel, // Upload logic will be added later
              style: ElevatedButton.styleFrom(
